...
class Mind_Category_Block_Adminhtml_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('category')->__('Title'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('category')->__('Item Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
      ...
      $this->addColumn('status', array(
		...
		$this->addExportType('*/*/exportXml', Mage::helper('category')->__('XML'));
    ...
    protected function _prepareMassaction()
    {
        ...
        $statuses = Mage::getSingleton('category/status')->getOptionArray();

        array_unshift($statuses, array('label'=>'', 'value'=>''));
        $this->getMassactionBlock()->addItem('status', array(
             'label'=> Mage::helper('category')->__('Change status'),

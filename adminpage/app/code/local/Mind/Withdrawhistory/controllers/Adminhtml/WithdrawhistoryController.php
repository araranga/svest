...
class Mind_Withdrawhistory_Adminhtml_WithdrawhistoryController extends Mage_Adminhtml_Controller_action
{
	...
	public function csvsAction()
	{
		...
		if($_GET['r']=='bank')
		{
		$rows = mysql_query("SELECT b.accounts_id,b.username,transnum,firstname,lastname,email,amount,bank_name,bank_accountnumber,bank_accountname FROM  tbl_withdraw_history as a JOIN tbl_accounts as b WHERE claim_status=0 AND a.accounts_id=b.accounts_id AND claimtype='".$_GET['r']."'
		");
		$array = explode(",","accounts_id,username,transnum,firstname,lastname,email,amount,bank_name,bank_accountnumber,bank_accountname");	
		}

		if($_GET['r']=='remit')
		{
		$rows = mysql_query("SELECT b.accounts_id,b.username,transnum,firstname,lastname,email,amount,remit_name,a.name,a.address,a.phone FROM  tbl_withdraw_history as a JOIN tbl_accounts as b WHERE claim_status=0 AND a.accounts_id=b.accounts_id AND claimtype='".$_GET['r']."'");
		$array = explode(",","accounts_id,username,transnum,firstname,lastname,email,amount,remit_name,name,address,phone");	
		}

		if($_GET['r']=='smartpadala')
		{
		$rows = mysql_query("SELECT b.accounts_id,b.username,transnum,firstname,lastname,email,amount,smartpadala,a.name,a.address,a.phone FROM  tbl_withdraw_history as a JOIN tbl_accounts as b WHERE claim_status=0 AND a.accounts_id=b.accounts_id AND claimtype='".$_GET['r']."'");
		$array = explode(",","accounts_id,username,transnum,firstname,lastname,email,amount,smartpadala,name,address,phone");	
		}

		if($_GET['r']=='pickup')
		{
		$rows = mysql_query("SELECT b.accounts_id,b.username,transnum,firstname,lastname,email,amount FROM  tbl_withdraw_history as a JOIN tbl_accounts as b WHERE claim_status=0 AND a.accounts_id=b.accounts_id AND claimtype='".$_GET['r']."'");
		$array = explode(",","accounts_id,username,transnum,firstname,lastname,email,amount");	
		}
